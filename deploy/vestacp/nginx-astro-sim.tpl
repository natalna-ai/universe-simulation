server {
    ...
    # API reverse proxy to Node app (default port 3001, override via $natalna_api_port if set)
    location /api/ {
    ...
    location = /error/404.html { root /usr/share/nginx/html; internal; }
    location = /error/50x.html { root /usr/share/nginx/html; internal; }
